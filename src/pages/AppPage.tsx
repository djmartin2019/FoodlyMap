  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col px-6 py-12 md:px-8">
      ...
      <div className="rounded-2xl border border-surface/60 bg-surface/30 p-8 shadow-neon-sm">
        <h2 className="mb-4 text-2xl font-semibold text-accent">Coming Soon</h2>
        <p className="text-text/80">
          Your personal food map and features will be available here soon.
        </p>
        <p className="mt-2 text-sm text-text/60">
          Stay tuned for map features, lists, and social connections.
        </p>
      </div>
    </div>
  );
